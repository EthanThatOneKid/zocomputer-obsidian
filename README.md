...
A Go-by-Example-style guide to setting up [obsidian-web](https://github.com/MusiCode1/obsidian-web) on [Zo](https://zo.computer).
Security posture audited by [Fable 5](https://www.zo.computer/chats/pub_NLaALvxPv35t78Ga).

https://ethanthatonekid.github.io/zocomputer-obsidian/

## Source of truth

The copyable setup prompts live in `skills/zocomputer-obsidian/prompts/`.
Edit those Markdown files first, then run:

```bash
node scripts/render-prompts.js
```

That command also updates this file with the rendered prompts below. If you see prompt content above this line, it was generated — edit the source Markdown files in `skills/` instead.

## Password-Protected Prompt

<!-- prompt:password-protected:start -->
