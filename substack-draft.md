# The Right to Your Knowledge

_Why your notes, docs, and operating memory should live in files you own._

This is not about any one app.

It is about the bargain: put your notes, docs, project boards, operating manuals, research trails, and half-formed ideas inside a platform, then keep paying rent to access the shape of your own work.

That is a bad place for a knowledge base to live.
...
I do not want to become a sysadmin. I want a machine I can direct. I describe the desired state, and the agent does the mechanical work: clone the repo, install dependencies, configure auth, start the service, verify the URL, and report back.
